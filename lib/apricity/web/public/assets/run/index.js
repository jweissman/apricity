...
console.log('[Init] Created initial jobs:', Object.keys(initialJobs));
...
if (outputTails && Object.keys(outputTails).length > 0) {
  ...
  console.log('[Hydration] Tail node IDs:', Object.keys(outputTails));
  console.log('[Hydration] Job IDs in run:', Object.keys(run.jobs));
