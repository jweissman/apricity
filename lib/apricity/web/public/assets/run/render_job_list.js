    ...
    <ul class="space-y-2">
      ...
      .map(
        ([nodeId, job]) => {
          ...
          return `<li>
              <a href="#${nodeId}" 
                 class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${isActive ? 'bg-blue-600/20 text-blue-400 border border-blue-500/30' : 'hover:bg-gray-800 text-gray-900 hover:text-gray-200'}">
