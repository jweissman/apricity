...
(function() {
  ...
  helpDiv.innerHTML = `
    ...
    <div class="space-y-2 text-sm">
      <div class="flex justify-between gap-4"><span class="text-gray-400">Toggle help</span><kbd>?</kbd></div>
      <div class="flex justify-between gap-4"><span class="text-gray-400">Go to dashboard</span><kbd>h</kbd></div>
      <div class="flex justify-between gap-4"><span class="text-gray-400">Next / prev job</span><span><kbd>j</kbd> <kbd>k</kbd></span></div>
      <div class="flex justify-between gap-4"><span class="text-gray-400">Expand / collapse all</span><kbd>e</kbd></div>
      <div class="flex justify-between gap-4"><span class="text-gray-400">Refresh</span><kbd>r</kbd></div>
      <div class="flex justify-between gap-4"><span class="text-gray-400">Close dialogs</span><kbd>Esc</kbd></div>
    </div>
  `;
